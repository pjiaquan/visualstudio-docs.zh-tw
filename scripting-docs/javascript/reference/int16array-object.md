---
title: "Int16Array 物件 | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
---
# Int16Array 物件
16 位元整數值的類型陣列。  內容已初始化為 0。  如果無法配置要求的位元組數目，就會引發例外狀況。  
...
|常數|描述|  
|--------|--------|  
|[BYTES\_PER\_ELEMENT 常數](../../javascript/reference/bytes-per-element-constant-int16array.md)|陣列中每個元素的大小 \(以位元組為單位\)。|  
