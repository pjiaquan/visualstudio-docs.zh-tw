---
title: "subarray 方法 (Uint16Array) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
---
# subarray 方法 (Uint16Array)
指定子陣列的第一個和最後一個成員，為這個陣列取得 [ArrayBuffer 物件](../../javascript/reference/arraybuffer-object.md) 存放區的新 Uint16Array 檢視。  
