...
10. 在 \[控制項\] 群組中，按一下 \[下拉式方塊\] 按鈕 ![ComboBoxContentControl](../vsto/media/combobox.png "ComboBoxContentControl")，將 <xref:Microsoft.Office.Tools.Word.ComboBoxContentControl> 加入第三個儲存格。  
