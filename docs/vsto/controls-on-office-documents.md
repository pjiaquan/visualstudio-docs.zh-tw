---
title: "Office 文件上的控制項 | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "控制項 [Visual Studio 中的 Office 程式開發]，關於 Office 文件上的主控制項"
  - "Office 文件 [Visual Studio 中的 Office 程式開發]，控制項"
  - "文件層級自訂 [Visual Studio 中的 Office 程式開發]，控制項"
  - "控制項 [Visual Studio 中的 Office 程式開發]"
  - "文件 [Visual Studio 中的 Office 程式開發]，控制項"
...
---
# Office 文件上的控制項
  您也可以在 Visual Studio 中使用 Office 開發工具，將 Windows Forms 控制項和「主控制項」[!INCLUDE[appliesto_controls](../vsto/includes/appliesto-controls-md.md)]\(Host Control\) 加入 Word 文件和 Excel 工作表。 主控制項是一種物件，在 Word 和 Excel 物件模型中擴充各種使用者介面 \(UI\) 物件。  
