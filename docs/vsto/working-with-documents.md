...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "文件 [Visual Studio 中的 Office 程式開發], 一般工作"
  - "Office 文件 [Visual Studio 中的 Office 程式開發], 一般工作"
  - "Word [Visual Studio 中的 Office 程式開發], 一般文件工作"
...
|在文件中加入頁首或頁尾。|[如何：以程式設計方式在文件中加入頁首和頁尾](../vsto/how-to-programmatically-add-headers-and-footers-to-documents.md)|  
