...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "表格 [Visual Studio 中的 Office 程式開發]"
  - "Office 文件 [Visual Studio 中的 Office 程式開發]，資料表"
  - "Word [Visual Studio 中的 Office 程式開發]，資料表"
  - "文件 [Visual Studio 中的 Office 程式開發]，資料表"
...
|將資料列或資料行加入資料表。|[如何：以程式設計方式在 Word 表格中加入列和欄](../vsto/how-to-programmatically-add-rows-and-columns-to-word-tables.md)|  
