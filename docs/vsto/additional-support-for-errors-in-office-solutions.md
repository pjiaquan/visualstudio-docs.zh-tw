...
helpviewer_keywords: 
  ...
  - "Visual Studio 中的 Office 程式開發, 錯誤"
...
---
# Office 方案錯誤的其他支援
  您可以使用下列資源，尋找在 Visual Studio 中建立 Office 方案遇到問題時的解決方式。  
  
## 疑難排解特定錯誤  
 如需 Office 方案中幾個常見錯誤的疑難排解協助，請參閱下列主題：  
...
## 其他資源  
 ...
 提供論壇，討論 Visual Studio 中 Office 開發人員工具的相關問題。  
  
 [Office 討論群組](http://go.microsoft.com/fwlink/?LinkId=63585)  
 提供 Office 應用程式相關問題的新聞群組體驗。  針對 Office 應用程式的物件模型相關的特定工作問題，請在此使用程式設計新聞群組。  
 ...
 提供其他資源連結，讓您進一步了解關於開發 Office 方案和使用 Visual Studio 進行的 Office 開發工作。  
