---
title: "Office UI 自訂逐步解說 | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
helpviewer_keywords: 
  - "執行窗格，逐步解說"
  - "智慧文件，逐步解說"
  - "逐步解說 [Visual Studio 中的 Office 程式開發]，智慧標籤"
  - "逐步解說 [Visual Studio 中的 Office 程式開發]，執行窗格"
...
## Word 文件上的控制項  
 [逐步解說：在執行階段於 VSTO 增益集中，將控制項加入文件](../vsto/walkthrough-adding-controls-to-a-document-at-run-time-in-a-vsto-add-in.md)  
