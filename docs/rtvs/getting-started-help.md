...
![Visual Studio 的 [說明] 視窗](~/docs/rtvs/media/help-window.png)
...
![說明搜尋結果](~/docs/rtvs/media/help-search1.png)

[說明] 視窗也有搜尋輸入欄位，讓您可以直接在 R 文件中執行進一步搜尋︰

![使用輸入欄位的說明搜尋結果](~/docs/rtvs/media/help-search2.png)
...
- 以滑鼠右鍵按一下搜尋字詞 (例如函式)，然後選取 [說明於] 命令，或是只按 F1 鍵，即可開啟該函式的說明。 您也可以對任何選取範圍叫用 [說明於]。
    ...
    ![透過以滑鼠右鍵按一下的操作功能表叫用說明](~/docs/rtvs/media/help-right-click.png)
...
![Visual Studio 中的網路搜尋結果](~/docs/rtvs/media/help-web-search-results.png)

您可以變更附加的字串 `R site:stackoverflow`，透過 [R 工具] > [選項] > [F1 網路搜尋字串] 選項︰

![變更 F1 網路搜尋字串選項](~/docs/rtvs/media/options-dialog.png)
