...
使用可能未指派的欄位 'field'  
 ...
 在結構中使用了欄位，但未先加以初始化。 若要解決這個問題，請先判斷哪個欄位未初始化，然後加以初始化，再嘗試存取。 如需初始化結構的詳細資訊，請參閱[結構](/dotnet/csharp/programming-guide/classes-and-structs/structs) 和[使用結構](/dotnet/csharp/programming-guide/classes-and-structs/using-structs)。  
