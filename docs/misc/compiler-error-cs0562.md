...
一元運算子的參數必須為包含類型  
 ...
 運算子多載的方法宣告必須遵循特定的指導方針。 如需詳細資訊，請參閱[多載運算子](/dotnet/csharp/programming-guide/statements-expressions-operators/overloadable-operators)和[Operator Overloading Sample](http://msdn.microsoft.com/zh-tw/1c6b4610-0a49-4532-8fa7-f694cfc65743)。  
