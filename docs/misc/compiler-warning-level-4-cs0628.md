...
'member': 在密封類別中宣告了新的 protected 成員  
 ...
 [sealed](/dotnet/csharp/language-reference/keywords/sealed) 類別不能引入 [protected](/dotnet/csharp/language-reference/keywords/protected) 成員，因為沒有其他類別可以繼承自 `sealed` 類別，並且使用 `protected` 成員。  
