...
---
# &#39;New&#39; 無法在介面上使用
將變數宣告為介面類型時，[Dim Statement](/dotnet/visual-basic/language-reference/statements/dim-statement) 會使用 [New Operator](/dotnet/visual-basic/language-reference/operators/new-operator) 子句。  
