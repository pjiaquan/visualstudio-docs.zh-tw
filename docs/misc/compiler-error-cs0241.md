...
不允許預設參數規範  
 ...
 [方法參數](/dotnet/csharp/language-reference/keywords/method-parameters)不可以有預設值。 如果您想要達到相同的效果，請使用方法多載。 如需詳細資訊，請參閱[傳遞參數](/dotnet/csharp/programming-guide/classes-and-structs/passing-parameters)。  
