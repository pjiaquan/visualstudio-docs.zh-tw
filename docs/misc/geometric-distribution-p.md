...
## 備註  
 如需程式碼範例，請參閱[geometric\_distribution 類別](/visual-cpp/standard-library/geometric-distribution-class)。  
...
## 請參閱  
 ...
 [geometric\_distribution 類別](/visual-cpp/standard-library/geometric-distribution-class)