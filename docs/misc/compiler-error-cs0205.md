...
無法呼叫抽象基底成員: 'method'  
 ...
 您無法呼叫 [abstract](/dotnet/csharp/language-reference/keywords/abstract) 方法，因為它沒有方法主體。 如需詳細資訊，請參閱[抽象和密封類別以及類別成員](/dotnet/csharp/programming-guide/classes-and-structs/abstract-and-sealed-classes-and-class-members)。  
