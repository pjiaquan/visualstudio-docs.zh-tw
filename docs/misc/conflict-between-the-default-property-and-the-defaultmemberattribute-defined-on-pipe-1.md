...
類別、結構或介面使用 [Default](/dotnet/visual-basic/language-reference/modifiers/default) 關鍵字來宣告預設屬性，但也套用 <xref:System.Reflection.DefaultMemberAttribute> 以將不同的成員指定為預設成員。  
