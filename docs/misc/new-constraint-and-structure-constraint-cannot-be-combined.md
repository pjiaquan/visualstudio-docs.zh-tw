...
條件約束清單同時包含 [New Operator](/dotnet/visual-basic/language-reference/operators/new-operator) 條件約束和 [Structure \(Visual Basic\)](http://msdn.microsoft.com/zh-tw/263ce115-ac36-4c05-8cb7-0e0eead5c6d0) 條件約束。  
