...
'member': 無法覆寫繼承的成員 'inherited member'，因為其已密封  
 ...
 成員無法[覆寫](/dotnet/csharp/language-reference/keywords/override)[密封](/dotnet/csharp/language-reference/keywords/sealed)的繼承成員。 如需詳細資訊，請參閱[Checked 與 Unchecked](/dotnet/csharp/language-reference/keywords/checked-and-unchecked)。  
