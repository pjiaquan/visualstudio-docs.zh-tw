...
# __sealed
> [!NOTE]
>  本主題只適用於 Managed Extensions for C\+\+ 第 1 版。 這個語法只可用於維護第 1 版的程式碼。 請參閱 [sealed](/visual-cpp/windows/sealed-cpp-component-extensions) 如需新語法中使用的相同功能。  
...
-   **\_\_Sealed** 搭配使用時，不允許關鍵字 [\_\_interface](/visual-cpp/cpp/interface) 關鍵字。  
