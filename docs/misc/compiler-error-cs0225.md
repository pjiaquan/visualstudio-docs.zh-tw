...
params 參數必須是單一維度陣列  
 ...
 使用 [params](/dotnet/csharp/language-reference/keywords/params) 關鍵字時，您必須指定資料類型的一維陣列。 如需詳細資訊，請參閱[方法](/dotnet/csharp/programming-guide/classes-and-structs/methods)。  
