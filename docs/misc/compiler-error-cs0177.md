...
在程式控制權脫離目前的方法之前，必須指派 out 參數 'parameter'  
 ...
 未在方法主體中指派值給以 [out](/dotnet/csharp/language-reference/keywords/out) 關鍵字標記的參數。 如需詳細資訊，請參閱[傳遞參數](/dotnet/csharp/programming-guide/classes-and-structs/passing-parameters)。  
