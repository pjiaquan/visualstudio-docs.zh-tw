...
指派陳述式將程序的位址指派給委派變數，但編譯器找不到具有相符簽章之程序的版本。  
 ...
 程式碼使用程序的位址時，編譯器會嘗試尋找該程序的版本，而該程序的版本具有符合委派版本的參數清單。 如果程序定義在數個多載版本中，則編譯器會嘗試尋找具有相符簽章的單一版本。 如需詳細資訊，請參閱[Overload Resolution](/dotnet/visual-basic/programming-guide/language-features/procedures/overload-resolution)。  
