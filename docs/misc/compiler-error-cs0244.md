...
'is' 或 'as' 在指標類型上都無效  
 ...
 [is](/dotnet/csharp/language-reference/keywords/is) 和 [as](/dotnet/csharp/language-reference/keywords/as) 關鍵字不適用於指標類型。 如需詳細資訊，請參閱[Unsafe 程式碼和指標](/dotnet/csharp/programming-guide/unsafe-code-pointers/index)。  
