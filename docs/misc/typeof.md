...
---
# __typeof
**注意**：本主題只適用於 Managed Extensions for C\+\+ 第 1 版。 這個語法只可用於維護第 1 版的程式碼。 請參閱 [typeid](/visual-cpp/windows/typeid-cpp-component-extensions) 如需新語法中使用的相同功能。  
...
## 備註  
 **\_\_typeof** 運算子可讓您取得您所指定之類型的 **System::Type** 類型。**\_\_typeof** 也可用於在自訂屬性區塊中傳回 **System::Type** 的值。 如需有關自行建立屬性的詳細資訊，請參閱[屬性](/visual-cpp/windows/attribute)。  
