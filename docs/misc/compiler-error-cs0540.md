...
'介面成員': 包含類型未實作介面 'interface'  
 ...
 您嘗試在[類別](/dotnet/csharp/language-reference/keywords/class)中實作非衍生自[介面](/dotnet/csharp/language-reference/keywords/interface)的介面成員。 您應該刪除介面成員的實作，或將介面加入類別的基底類別清單中。  
