...
-   加入具有 coclass 之組件的參考 \(介面和 coclass 大部分的時間都應該在相同的組件中\)。 如需相關資訊，請參閱 [\/reference](/dotnet/csharp/language-reference/compiler-options/reference-compiler-option) 或[加入參考對話方塊](http://msdn.microsoft.com/zh-tw/2feb0fe2-0805-4cc9-8cba-b0315849dfb7)。  
