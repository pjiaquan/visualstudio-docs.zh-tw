...
過時的成員 'memberA' 會覆寫非過時的成員 'memberB'。  
 ...
 一般而言，標記為過時的成員不應該覆寫未標記為過時的成員。[!INCLUDE[vs_orcas_long](../debugger/includes/vs_orcas_long_md.md)] 中會產生這個警告，但 [!INCLUDE[vsprvslong](../code-quality/includes/vsprvslong_md.md)] 中則不會。  
