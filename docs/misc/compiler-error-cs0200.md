...
無法指派屬性或索引子 'property' \-\- 其為唯讀  
 ...
 已嘗試指派值給[屬性](/dotnet/csharp/programming-guide/classes-and-structs/using-properties)，但此屬性沒有 set 存取子。 請加入 set 存取子來解決此錯誤。 如需詳細資訊，請參閱[如何：宣告及使用讀寫屬性](../Topic/How%20to:%20Declare%20and%20Use%20Read%20Write%20Properties%20\(C%23%20Programming%20Guide\).md)。  
