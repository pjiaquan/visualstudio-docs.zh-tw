...
params 參數必須是型式參數清單中的最後一個參數。  
 ...
 [params](/dotnet/csharp/language-reference/keywords/params) 參數支援數目不定的引數，且必須在所有其他參數之後。 如需詳細資訊，請參閱[方法](/dotnet/csharp/programming-guide/classes-and-structs/methods)。  
