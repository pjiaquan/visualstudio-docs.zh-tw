...
`WriteOnly` 屬性宣告可在 [Property Statement](/dotnet/visual-basic/language-reference/statements/property-statement) 和 [Set Statement](/dotnet/visual-basic/language-reference/statements/set-statement) 中指定存取層級。  
