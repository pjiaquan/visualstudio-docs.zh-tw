...
---
# 泛型方法不可以公開至 COM
包含一或多個泛型程序的 [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] 元件匯出至 COM 元件。  
...
-   請從 [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] 元件中移除泛型程序，或不要將它用於 COM Interop。  
