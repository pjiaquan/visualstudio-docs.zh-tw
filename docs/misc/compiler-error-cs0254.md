...
fixed 陳述式指派運算子的右邊不能是 cast 運算式  
 ...
 [fixed](/dotnet/csharp/language-reference/keywords/fixed-statement) 運算式的右邊不能使用 cast。 如需詳細資訊，請參閱[Unsafe 程式碼和指標](/dotnet/csharp/programming-guide/unsafe-code-pointers/index)。  
