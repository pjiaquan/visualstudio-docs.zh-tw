...
[Event Statement](/dotnet/visual-basic/language-reference/statements/event-statement) 使用委派來指定其簽章，但 [Delegate Statement](/dotnet/visual-basic/language-reference/statements/delegate-statement) 已標記為 `<CLSCompliant(False)>` 或未標記。  
