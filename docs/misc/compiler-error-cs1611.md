...
params 參數不可宣告為 ref 或 out  
 ...
 關鍵字 [ref](/dotnet/csharp/language-reference/keywords/ref) 或 [out](/dotnet/csharp/language-reference/keywords/out) 不能與 [params](/dotnet/csharp/language-reference/keywords/params) 關鍵字搭配使用。  
