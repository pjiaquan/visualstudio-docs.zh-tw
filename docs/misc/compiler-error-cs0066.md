...
'event': 事件必須為委派類型  
 ...
 event 關鍵字需要[委派](/dotnet/csharp/language-reference/keywords/delegate)類型。 如需詳細資訊，請參閱[事件](/dotnet/csharp/programming-guide/events/index)與[委派](/dotnet/csharp/programming-guide/delegates/index)。  
