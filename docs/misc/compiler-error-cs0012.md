...
類型 'type' 定義在未被參考的組件中。 您必須加入對組件 'assembly' 的參考。  
 ...
 找不到參考類型的定義。 如果必要的 DLL 檔案未包含在編譯中，就會發生此狀況。 如需詳細資訊，請參閱[Add Reference Dialog Box](http://msdn.microsoft.com/zh-tw/2feb0fe2-0805-4cc9-8cba-b0315849dfb7)與[\/reference \(Import Metadata\)](/dotnet/csharp/language-reference/compiler-options/reference-compiler-option)。  
