...
在 \[命令\] 視窗或 \[尋找\/命令\] 方塊中輸入 \/e:*editorname* 引數的不正確值時，通常就會發生這項錯誤。  
  
### 若要更正這個錯誤  
  
1.  請檢查文件中正確的 \/e:*editorname* 語法，並重新輸入命令。  
  
## 請參閱  
 [新增檔案命令](../ide/reference/new-file-command.md)   
 [開啟檔案命令](../ide/reference/open-file-command.md)   
 [加入新項目命令](../ide/reference/add-new-item-command.md)   
 [加入現有項目命令](../ide/reference/add-existing-item-command.md)