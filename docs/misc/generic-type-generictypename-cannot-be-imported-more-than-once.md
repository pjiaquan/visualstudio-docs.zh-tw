...
---
# 泛型類型 &#39;&lt;泛型類型名稱&gt;&#39; 無法匯入多次
[Imports Statement \(.NET Namespace and Type\)](/dotnet/visual-basic/language-reference/statements/imports-statement-net-namespace-and-type) 指定了使用不同類型參數化匯入的泛型類型。  
