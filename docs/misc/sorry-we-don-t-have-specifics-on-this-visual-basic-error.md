...
很抱歉，我們沒有任何有關此錯誤的特定資訊。  您可以搜尋錯誤代碼和訊息文字來尋找網路上的資訊。  或者，您可以要求其他開發人員使用這些論壇的其中一個：  
 ...
 所提供的論壇是關於 [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] 語言語法和編譯器的問題和一般討論。  
  
 [Visual Basic Interop 和升級](http://go.microsoft.com/fwlink/?LinkId=145966)  
 提供升級至 [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] 及使用互通性功能之問題的論壇。  
  
 [Visual Basic IDE](http://go.microsoft.com/fwlink/?LinkId=145971)  
 提供關於如何在 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 環境中工作之問題的論壇。  
  
 [Visual Basic 一般](http://go.microsoft.com/fwlink/?LinkId=145973)  
 提供其他論壇中沒有討論之 [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] 問題的論壇。  
  
 [StackOverflow](http://stackoverflow.com/questions/tagged/vb.net)  
 提供關於 [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] 問題的論壇。  
