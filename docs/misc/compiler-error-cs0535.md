...
'class' 未實作介面成員 'member'  
 ...
 [類別](/dotnet/csharp/language-reference/keywords/class)衍生自[介面](/dotnet/csharp/language-reference/keywords/interface)，但是類別未實作一個或多個介面的成員。 類別必須實作從中衍生或宣告為 `abstract` 之介面的所有成員。  
