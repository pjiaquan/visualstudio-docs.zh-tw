---
title: "了解 Xamarin 的行動應用程式開發 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
本主題引導您前往概觀資料，以協助您了解如何使用 Xamarin 開發跨平台行動應用程式。 如果您尚未安裝 Visual Studio 和 Xamarin，請先開始進行[設定和安裝](../cross-platform/setup-and-install.md)程序，然後在安裝程式執行時，返回此處來檢閱這些資源。  
...
5.  (選擇性) Jason Smith (MSDN Magazine) 的[跨平台 - 跨行動平台與 Xamarin.Forms 共用 UI 程式碼 (英文)](https://msdn.microsoft.com/magazine/dn904669.aspx) 概述 Xamarin.Forms 中的不同自訂選項，其詳細資訊則包含在[自訂每個平台上的控制項 (英文)](http://developer.xamarin.com/guides/xamarin-forms/custom-renderer/) (xamarin.com) 中。  
...
##  <a name="a-namecomponentsa-deeper-dive-xamarin-components"></a><a name="components"></a> 深入探討：Xamarin 元件  
 10 分鐘  
