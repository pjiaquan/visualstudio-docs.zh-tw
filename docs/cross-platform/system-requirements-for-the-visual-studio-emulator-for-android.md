---
title: "Visual Studio Emulator for Android 的系統需求 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# Visual Studio Emulator for Android 的系統需求
...
-   64 位元版的 Windows 8、Windows 8.1、Windows10 或更高的 Pro 版本。  
 ...
 ![確認系統需求](../cross-platform/media/android_emu_system_requirements.png "Android\_Emu\_System\_Requirements")  
...
>  加入此群組之後，請登出或重新開機，以讓變更生效。  
 ...
 ![加入 Hyper&#45;V 的系統管理員群組](../cross-platform/media/android_emu_hyperv_admin.png "Android\_Emu\_HyperV\_Admin")  
...
##  <a name="BootableVHD"></a> 不支援從可開機的 VHD 執行模擬器  
 ...
 不支援這個組態。 如需相關問題資訊，請參閱[Visual Studio Emulator for Android 疑難排解](../cross-platform/troubleshooting-the-visual-studio-emulator-for-android.md)。  
