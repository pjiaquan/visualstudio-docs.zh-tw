...
若要為 Visual C\# .NET 和 Visual Basic .NET 專案設計新的類型，請在類別圖上建立這些類型。  若要查看現有的類型，請參閱[How to: View Existing Types \(Class Designer\)](../Topic/How%20to:%20View%20Existing%20Types%20\(Class%20Designer\).md)。  
...
3.  選取您要為類型加入之初始程式碼的檔案：  
    ...
    -   若要建立新的檔案並將它加入至目前的專案，請選取 \[**建立新檔案**\] 並為檔案命名。  
  
    -   若要將程式碼加入至現有的檔案，請選取 \[**加入至現有檔案**\]。  
...
##  <a name="CustAttributeType"></a> 將自訂屬性套用至類型  
