...
### <a name="access-your-azure-account-in-server-explorer"></a>在伺服器總管中存取您的 Azure 帳戶  
 ...
 ![顯示展開之 Azure Tools 節點的伺服器總管](~/docs/ide/media/vs2015_serverexplorer.png "VS2015_ServerExplorer")  
 ...
 ![[管理 Azure 訂用帳戶] 對話方塊](~/docs/ide/media/vs2015_manage_subs.png "vs2015_manage_subs")  
...
###  <a name="a-nameaccessazurea-access-azure-active-directory-in-a-web-project"></a><a name="access_azure"></a> 在 Web 專案中存取 Azure Active Directory  
 ...
 ![ASP.NET 的 [變更驗證] 對話方塊](~/docs/ide/media/vs2015_change_authentication.png "VS2015_change_authentication")  
...
## <a name="add-a-second-user-account-to-visual-studio"></a>將第二個使用者帳戶加入 Visual Studio  
 ...
 ![Visual Studio 帳戶選擇器](~/docs/ide/media/vs2015_acct_picker.png "VS2015_acct_picker")  
