...
-   Visual C# .NET 或 Visual Basic .NET 程式碼  
 ...
 ![CodeLens &#45; 查看參考](~/docs/ide/media/codelensviewreferencespeekreference.png "CodeLensViewReferencesPeekReference")  
...
-   [Lync 2010 或更新版本或是商務用 Skype](http://technet.microsoft.com/en-us/lync)，以從程式碼編輯器連絡您的小組  
 ...
 ![程式碼項目&#45;層級指標](~/docs/ide/media/codelenselementlevelindicators.png "CodeLensElementLevelIndicators")  
  
 對於可以在 Visual Studio 編輯器中開啟的所有其他類型的檔案，將可於視窗的下方取得整個檔案的 CodeLens 詳細資料 (*檔案層級* 指標)。  
  
 ![檔案&#45;層級 CodeLens 指標](~/docs/ide/media/almcodelensfilelevelindicators.png "ALMCodeLensFileLevelIndicators")  
  
 若要使用鍵盤來選取指標，請按住 **ALT** 鍵以顯示相關數字鍵。  
  
 ![按下 ALT 鍵以查看鍵盤存取號碼](~/docs/ide/media/codelensaltkeyindicators.png "CodeLensAltKeyIndicators")  
...
### <a name="find-changes-in-your-code"></a>尋找您程式碼中的變更  
 ...
 ![CodeLens：取得 TFVC 中的程式碼變更記錄](~/docs/ide/media/codelenscodechanges.png "CodeLensCodeChanges")  
 ...
 ![顯示所有程式碼變更](~/docs/ide/media/codelensshowsallchanges.png "CodeLensShowsAllChanges")  
  
 這會開啟變更集的 [記錄] 視窗。  
  
 ![所有程式碼變更的歷程記錄視窗](~/docs/ide/media/codelenscodechangeshistory.png "CodeLensCodeChangesHistory")  
  
 當您的檔案放在 Git 儲存機制中，而您選擇程式碼項目層級變更指標時，這就是您所看到的。  
  
 ![CodeLens：取得 Git 中的程式碼變更記錄](~/docs/ide/media/codelenscodechangesgit.png "CodeLensCodeChangesGit")  
 ...
 ![CodeLens：以圖形方式檢視程式碼變更記錄](~/docs/ide/media/codelens.png "CodeLens")  
...
#### <a name="find-incoming-changes-from-other-branches"></a>尋找其他分支傳入的變更  
 ![CodeLens：尋找其他分支的程式碼變更](~/docs/ide/media/codelensbranchchangecheckinconceptual.png "CodeLensBranchChangeCheckinConceptual")  
...
|**圖示**|**變更的出處為何？**|  
|--------------|-----------------------------------------|  
|![CodeLens：從目前分支變更圖示](~/docs/ide/media/codelensbranchcurrenticon.png "CodeLensBranchCurrentIcon")|目前分支|  
|![CodeLens &#45; 從父分支變更圖示](~/docs/ide/media/codelensbranchparenticon.png "CodeLensBranchParentIcon")|父分支|  
|![CodeLens：從子分支變更圖示](~/docs/ide/media/codelensbranchchildicon.png "CodeLensBranchChildIcon")|子分支|  
|![CodeLens &#45; 從對等分支變更圖示](~/docs/ide/media/codelensbranchpeericon.png "CodeLensBranchPeerIcon")|對等分支|  
|![CodeLens &#45; 從更遠分支變更圖示](~/docs/ide/media/codelensbranchfurtherawayicon.png "CodeLensBranchFurtherAwayIcon")|比父分支、子分支或對等分支更遠的分支|  
|![CodeLens：從父分支合併圖示](~/docs/ide/media/codelensbranchmergefromparenticon.png "CodeLensBranchMergeFromParentIcon")|從父分支到子分支的合併|  
|![CodeLens：從子分支合併圖示](~/docs/ide/media/codelensbranchmergefromchildicon.png "CodeLensBranchMergeFromChildIcon")|從子分支到父分支的合併|  
|![CodeLens：從非相關的分支合併圖示](~/docs/ide/media/codelensbranchmergefromunrelatedicon.png "CodeLensBranchMergeFromUnrelatedIcon")|從不相關分支的合併 (無基礎的合併)|  
...
### <a name="contact-the-owner-of-an-item"></a>連絡項目擁有者  
 ![連絡項目擁有者](~/docs/ide/media/codelenscontactitemowner.png "CodeLensContactItemOwner")  
  
 開啟項目的捷徑功能表，查看連絡人選項。 如果您安裝了 Lync 或商務用 Skype，您會看到下列選項：  
  
 ![項目的連絡選項](~/docs/ide/media/codelensitemcontactmenu.png "CodeLensItemContactMenu")  
...
3.  如果您看到警告圖示 ![CodeLens &#45; 尚未執行的單元測試警告](~/docs/ide/media/codelenstestwarningicon.png "CodeLensTestWarningIcon")，請執行測試。  
...
5.  檢閱測試結果。 選擇測試狀態指標 (![CodeLens &#45; 單元測試失敗圖示](~/docs/ide/media/codelenstestfailedicon.png "CodeLensTestFailedIcon") 或 ![CodeLens &#45; 單元測試通過圖示](~/docs/ide/media/codelenstestpassedicon.png "CodeLensTestPassedIcon"))，或按 **Alt + 1**。  
 ...
 **答：**  除了參考指標之外，您可以關閉或開啟各個指標。 請依序移至 [工具] 、[選項] 、[文字編輯器] 、[所有語言] 和 [CodeLens] 。  
 ...
 ![開啟和關閉檔案&#45;層級指標](~/docs/ide/media/codelensfilelevelonandoff.png "CodeLensFileLevelOnAndOff")  
 ...
 **答︰**可以，選擇 ![CodeLens &#45; 停駐成為視窗](~/docs/ide/media/codelensdockwindow.png "CodeLensDockWindow")，來將 CodeLens 停駐成為視窗。  
  
 ![停駐 CodeLens 指標視窗](~/docs/ide/media/codelensselectdockwindow.png "CodeLensSelectDockWindow")  
  
 ![停駐的 CodeLens 參考視窗](~/docs/ide/media/codelensreferencesdockedwindow.png "CodeLensReferencesDockedWindow")  
