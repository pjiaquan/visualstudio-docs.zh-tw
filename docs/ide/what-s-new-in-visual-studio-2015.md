...
### 適用於任何 Windows 10 裝置的通用 Windows 應用程式  
 ...
 ![通用 Windows 平台](~/docs/cross-platform/media/uwp_coreextensions.png "UWP\_CoreExtensions")  
...
## 裝置預覽功能表列  
 ...
 ![裝置預覽功能表](~/docs/ide/media/vs2015_device_preview.png "vs2015\_device\_preview")  
...
4.  銷售力  
 ...
 ![&#91;加入已連接服務&#93; 對話方塊](~/docs/ide/media/vs2015_addconnectedservicedialog.png "VS2015\_AddConnectedServiceDialog")  
...
### 高解析度影像和觸控支援  
 ...
 ![編輯器的觸控支援](~/docs/ide/media/vs2015_touchsupport.png "VS2015\_TouchSupport")  
