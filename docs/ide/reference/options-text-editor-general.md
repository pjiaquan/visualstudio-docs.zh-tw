...
|選取範圍邊界起點|選取範圍邊界終點|  
|-------------------------|--------------------------|  
|![HTMLpageSelectionMarginOn 螢幕擷取畫面](~/docs/ide/reference/media/vxselmaron.gif "vxSelmaron")|![HTMLpageSelectionMarginOff 螢幕擷取畫面](~/docs/ide/reference/media/vxselmaroff.gif "vxSelmaroff")|  
