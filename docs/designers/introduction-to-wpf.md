...
Windows Presentation Foundation (WPF) 可讓您建立具有豐富視覺效果之使用者介面的 Windows 桌面用戶端應用程式。  
 ...
 ![Contoso Healthcare UI 範例](~/docs/designers/media/wpfintrofigure24.png "WPFIntroFigure24")  
...
```  
 ...
 ![包含按鈕的視窗](~/docs/designers/media/wpfintrofigure10.png "WPFIntroFigure10")  
...
```  
 ...
 ![訊息方塊](~/docs/designers/media/wpfintrofigure25.png "WPFIntroFigure25")  
...
>  WPF 建構是由父控制項實作並可供子控制項使用的屬性，又稱為 [附加屬性](https://msdn.microsoft.com/en-us/library/ms749011\(v=vs.100\).aspx)。  
 ...
 ![DockPanel 頁面](~/docs/designers/media/wpfintrofigure11.png "WPFIntroFigure11")  
...
### <a name="2-d-shapes"></a>2D 圖案  
 ...
 ![橢圓形和矩形](~/docs/designers/media/wpfintrofigure4.PNG "WPFIntroFigure4")  
 ...
 ![包含 "you clicked the ellipse&#33;" 文字的視窗](~/docs/designers/media/wpfintrofigure12.png "WPFIntroFigure12")  
...
### <a name="2-d-geometries"></a>2D 幾何  
 ...
 ![Path 的各種用法](~/docs/designers/media/wpfintrofigure5.PNG "WPFIntroFigure5")  
...
### <a name="2-d-effects"></a>2D 效果  
 ...
 ![不同筆刷的圖例](~/docs/designers/media/wpfintrofigure6.PNG "WPFIntroFigure6")  
...
### <a name="3-d-rendering"></a>3D 轉譯  
 ...
 ![Visual3D 範例螢幕擷取畫面](~/docs/designers/media/wpfintrofigure13.png "WPFIntroFigure13")  
...
##  <a name="Animation"></a> 動畫  
 ...
 ![動畫效果立方體的影像](~/docs/designers/media/wpfintrofigure7.png "WPFIntroFigure7")  
...
### <a name="images"></a>影像  
 ...
 ![縮圖影像與完整大小影像](~/docs/designers/media/wpfintrofigure8.PNG "WPFIntroFigure8")  
...
### <a name="video-and-audio"></a>視訊和音訊  
 ...
 ![具有音訊與視訊的 MediaElement 控制項](~/docs/designers/media/wpfintrofigure1.png "WPFIntroFigure1")  
...
-   國際字型支援和後援機制。  
 ...
 ![帶有各種文字裝飾的文字](~/docs/designers/media/wpfintrofigure23.png "WPFIntroFigure23")  
...
[!code-xml[IntroToWPFSnippets#TextBoxContentMARKUP3](../designers/codesnippet/Xaml/introduction-to-wpf_12.xaml)]  
 ...
 ![包含文字的 TextBox 控制項](~/docs/designers/media/wpfintrofigure21.png "WPFIntroFigure21")  
...
[!code-xml[IntroToWPFSnippets#ButtonContentMARKUP3](../designers/codesnippet/Xaml/introduction-to-wpf_15.xaml)]  
 ...
 ![包含多種類型內容的按鈕](~/docs/designers/media/wpfintrofigure22.png "WPFIntroFigure22")  
...
### <a name="control-templates"></a>控制項範本  
 ...
 ![橢圓形按鈕和第二個視窗](~/docs/designers/media/wpfintrofigure2.png "WPFIntroFigure2")  
...
### <a name="data-templates"></a>資料範本  
 ...
 ![具有預設外觀的清單方塊](~/docs/designers/media/wpfintrofigure18.png "WPFIntroFigure18")  
...
[!code-xml[IntroToWPFSnippets#DataTemplateMARKUP4](../designers/codesnippet/Xaml/introduction-to-wpf_21.xaml)]  
 ...
 ![使用資料範本的清單方塊](~/docs/designers/media/wpfintrofigure19.png "WPFIntroFigure19")  
...
[!code-xml[IntroToWPFSnippets#StyleMARKUP4](../designers/codesnippet/Xaml/introduction-to-wpf_25.xaml)]  
 ...
 ![兩個橙色按鈕](~/docs/designers/media/wpfintrofigure20.png "WPFIntroFigure20")  
...
-   **架構項目模型**： 如果其外觀是由自訂轉譯邏輯 (而不是範本) 所定義，自訂控制項衍生自 <xref:System.Windows.FrameworkElement> 。  
 ...
 ![自訂使用者控制項](~/docs/designers/media/wpfintrofigure3.png "WPFIntroFigure3")  
