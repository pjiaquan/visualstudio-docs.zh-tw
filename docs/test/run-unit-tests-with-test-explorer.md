...
##  <a name="BKMK_Unit_test_frameworks_and_test_projects"></a>單元測試架構和測試專案  
 ...
 ![回到頁首](~/docs/debugger/media/pcs_backtotop.png "PCS_BackToTop") [內容](#BKMK_Contents)  
...
|||  
|-|-|  
|![建置後執行](~/docs/test/media/ute_runafterbuild_btn.png "UTE_RunAfterBuild_btn")|若要在每次本機建置之後執行單元測試，請在標準功能表中選擇 [測試]  ，然後選擇測試總管工具列上的 [建置之後執行測試]  。|  
...
###  <a name="BKMK_View_test_details"></a> 檢視測試詳細資料  
 ...
 ![測試執行詳細資料](~/docs/test/media/ute_testdetails.png "UTE_TestDetails")  
...
###  <a name="BKMK_Grouping_the_test_list"></a> 分組測試清單  
 若要變更測試組織的方法，請選取 [群組依據] 按鈕![測試總管的 [群組] 按鈕](~/docs/test/media/ute_groupby_btn.png "UTE_GroupBy_btn")旁邊的向下箭號 ，然後選取新的群組準則。  
