...
2.  在方案總管中，開啟 MainPage.xaml。 從 [工具箱] 中，將按鈕控制項和文字方塊控制項拖曳至設計介面。  
     ...
     ![將控制項加入 MainPage.xaml](~/docs/test/media/cuit_phone_app_addcontrols.png "CUIT_Phone_App_AddControls")  
...
2.  選擇使用交叉線工具編輯 UI 對應。  
     ...
     ![使用交叉線工具產生自動程式化 UI 測試](~/docs/test/media/cuit_phone_howgencodedialog.png "CUIT_Phone_HowGenCodeDialog")  
