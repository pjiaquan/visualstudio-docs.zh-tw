...
![診斷工具摘要索引標籤](~/docs/profiling/media/DiagToolsSummaryTab-2.png "DiagToolsSummaryTab")
...
![診斷工具的呼叫端被呼叫端檢視](~/docs/profiling/media/DiagToolsCallerCallee.png "DiagToolsCallerCallee")
