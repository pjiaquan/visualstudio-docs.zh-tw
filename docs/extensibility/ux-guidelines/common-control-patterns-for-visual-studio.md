...
![因為內容已經超過限制的樹狀檢視控制項，則會顯示這兩個垂直和水平捲軸。](~/docs/extensibility/ux-guidelines/media/070705-4_scrollbars.png "070705-4_Scrollbars")<br />因為內容已經超過限制的樹狀檢視控制項，則會顯示這兩個垂直和水平捲軸。
