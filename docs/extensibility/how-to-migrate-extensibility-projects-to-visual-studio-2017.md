...
![VSSDK 建置工具](~/docs/extensibility/media/vssdk-build-tools.png)
...
* 選取**必要條件** 索引標籤，然後按下**新增** 按鈕。
  ...
  ![VSIX 資訊清單設計工具](~/docs/extensibility/media/vsix-manifest-designer.png)

* **加入新必要條件**視窗隨即開啟。

  ![新增 vsix 必要條件](~/docs/extensibility/media/add-vsix-prerequisite.png)
...
* 如有必要，請更新版本。
  ...
  ![新增 roslyn 必要條件](~/docs/extensibility/media/add-roslyn-prerequisite.png)
...
![啟動外部程式](~/docs/extensibility/media/start-external-program.png)
...
![在 Visual Studio 2017 VSIX 安裝程式](~/docs/extensibility/media/vsixinstaller-vs-2017.png)
...
![vs 執行處理程序](~/docs/extensibility/media/vs-running-processes.png)
...
![vsixinstaller 遺漏的必要條件](~/docs/extensibility/media/vsixinstaller-missing-prerequisite.png)
