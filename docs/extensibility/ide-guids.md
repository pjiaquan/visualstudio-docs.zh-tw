...
<xref:Microsoft.VisualStudio.VSConstants>類別發行的整合式的開發環境 (IDE) 的某些部分的 Guid，如下列表格所列。</xref:Microsoft.VisualStudio.VSConstants>  
...
## <a name="task-list-guids"></a>Guid 工作清單  
