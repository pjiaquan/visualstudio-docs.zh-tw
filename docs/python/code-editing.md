...
![成員自動完成](~/python/media/code-editing-completions-simple.png)
...
![簽章說明](~/python/media/code-editing-signature-help.png)
...
![快速諮詢](~/python/media/code-editing-quick-info.png)
...
![程式碼著色](~/python/media/code-editing-code-coloring.png)

若要自訂使用的色彩，請移至 [工具] > [選項] > [環境] > [字型和色彩]，並修改 [顯示項目] 清單中的 Python 項目。

![字型與色彩選項](~/python/media/code-editing-customize-colors.png)
...
![程式碼片段](~/python/media/code-editing-code-snippets.png)

您可以在 [程式碼片段管理員] 中看到可用的程式碼片段 ([工具] > [程式碼片段管理員])，選取 [Python] 做為語言︰

![程式碼片段管理員](~/python/media/code-editing-code-snippets-manager.png)
...
![巡覽列](~/python/media/code-editing-navigation-bar.png)
...
![移至定義](~/python/media/code-editing-go-to-definition.png)
...
![巡覽至](~/python/media/code-editing-navigate-to.png)
...
![[尋找所有參考] 結果](~/python/media/code-editing-find-all-references.png)
