...
![在 Azure 入口網站中啟用 Web 通訊端](~/docs/python/media/azure-remote-debugging-enable-web-sockets.png)
...
![正在對 Azure App Service 網站進行偵錯](~/docs/python/media/azure-remote-debugging-attached.png)
...
![Azure 遠端偵錯 Proxy 資訊頁面](~/docs/python/media/azure-remote-debugging-proxy-info-page.png)
...
![判斷 Azure App Service 中的偵錯工具端點](~/docs/python/media/azure-remote-debugging-secret.png)
...
![使用 [附加至處理序 (Attach to Process)] 對話方塊附加至 Azure 網站](~/docs/python/media/azure-remote-debugging-manual-attach.png)
