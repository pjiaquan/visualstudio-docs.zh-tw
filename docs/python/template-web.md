...
![新增 Web 專案範本](~/docs/python/media/template-web-new-project.png)
...
![安裝專案範本所需之封裝的對話方塊](~/docs/python/media/template-web-requirements-txt-wizard.png)
...
當啟動 Web 專案進行偵錯時，Visual Studio 會在本機啟動網頁伺服器，然後開啟預設瀏覽器並移至該位址及連接埠。 若要指定其他選項，請以滑鼠右鍵按一下專案，選取 [屬性]，並選取 [Web 啟動器] 索引標籤：
  ...
  ![一般 Web 範本的 Web 啟動器屬性](~/docs/python/media/template-web-launcher-properties.png)
...
![專案操作功能表上的 [發佈] 命令](~/docs/python/media/template-web-publish-command.png)
...
![在 Azure 入口網站上新增網站擴充功能](~/docs/python/media/template-web-site-extensions.png)
...
![Azure 項目範本](~/docs/python/media/template-web-azure-items.png)
...
![正在變更發佈設定](~/docs/python/media/template-web-publish-config.png)
...
![[轉換為 Microsoft Azure 雲端服務專案] 命令](~/docs/python/media/template-web-convert-menu.png)
