...
![Visual Studio 中的中斷點](~/docs/python/media/debugging-breakpoints.png)
...
![建立具有中斷點的追蹤點](~/docs/python/media/debugging-tracepoint.png)
...
![偵錯工具中的 DataTips](~/docs/python/media/debugging-quick-tips.png)

[自動變數 (Autos)] 視窗 ([偵錯 (Debug)] > [視窗 (Windows)] > [自動變數 (Autos)]) 包含與目前的陳述式相關的變數和運算式。 您可以在值資料行中按兩下或選取並按 F2 來編輯值︰

![偵錯工具中的 [自動變數 (Autos)] 視窗](~/docs/python/media/debugging-autos-window.png)

[區域變數 (Locals)] 視窗 ([偵錯 (Debug)] > [視窗 (Windows)] > [區域變數 (Locals)]) 會顯示目前範圍中可再次編輯的所有變數︰

![偵錯工具中的 [區域變數 (Locals)] 視窗](~/docs/python/media/debugging-locals-window.png)
...
![偵錯工具中的 [監看式 (Watch)] 視窗](~/docs/python/media/debugging-watch-window.png)
...
![字串視覺化工具](~/docs/python/media/debugging-string-visualizers.png)
...
![例外狀況快顯](~/docs/python/media/debugging-exception-popup.png)
...
![例外狀況視窗](~/docs/python/media/debugging-exception-settings.png)
...
![專案偵錯屬性](~/docs/python/media/debugging-project-properties.png)
...
![[Python 偵錯互動式 (Python Debug Interactive)] 視窗](~/docs/python/media/debugging-interactive.png)
...
![[偵錯互動式視窗 (Debug Interactive Window)] 選項](~/docs/python/media/debugging-interactive-options.png)
