...
2.  按一下或點選來啟動安裝程式，然後選取 [修改]。  
     ...
     ![啟動或修改 Visual Studio](~/docs/install/media/vs2017-modify.PNG "修改 Visual Studio 2017")  

3.  從 [工作負載] 畫面，選取或取消選取您想要安裝或解除安裝的工作負載。  

    ![Visual Studio 2017 安裝程式對話方塊](~/docs/install/media/vs2017-modify-workloads.PNG "在 Visual Studio 2017 中選擇工作負載")
