---
title:
- "Visual Studio Enterprise 2017 工作負載和元件識別碼 | Microsoft Docs"
...
Microsoft.VisualStudio.Component.TestTools.CodedUITest | 自動程式碼 UI 測試
...
Microsoft.VisualStudio.Component.TestTools.WebLoadTest | Web 效能與負載測試工具
