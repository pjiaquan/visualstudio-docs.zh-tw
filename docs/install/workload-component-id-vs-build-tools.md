---
title:
- "Visual Studio Build Tools 2017 工作負載和元件識別碼 | Microsoft Docs"
...
Microsoft.VisualStudio.Component.CoreBuildTools | Visual Studio Build Tools Core | 必要
...
元件識別碼 | 名稱 | 相依性類型
--- | --- | ---
Microsoft.VisualStudio.Component.VC.CoreBuildTools | Visual C++ Build Tools 核心功能 | 必要
...
元件識別碼 | 名稱 | 相依性類型
--- | --- | ---
Microsoft.VisualStudio.Web.BuildTools.ComponentGroup | Web 程式開發建置工具 | 必要
